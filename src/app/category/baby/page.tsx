...
const mockProducts = [
  { 
    id: 1, name: 'سرهمی نخی نوزادی', price: '۶۵۰,۰۰۰ تومان', rawPrice: 650000, 
    hasColors: true, gender: 'girl', type: 'dress',
  ...
  { 
    id: 2, name: 'ست دو تکه راحتی', price: '۸۲۰,۰۰۰ تومان', rawPrice: 820000, 
    hasColors: false, gender: 'boy', type: 'set',
    img1: 'https://images.unsplash.com/photo-1519689680058-324335c77eba?q=80&w=600&auto=format&fit=crop',
    img2: 'https://images.unsplash.com/photo-1555252333-9f8e92e65df9?q=80&w=600&auto=format&fit=crop'
  },
  { 
    id: 3, name: 'بادی آستین کوتاه', price: '۴۵۰,۰۰۰ تومان', rawPrice: 450000, 
    hasColors: true, gender: 'boy', type: 'tshirt',
  ...
  { 
    id: 4, name: 'پاپوش بافتنی نرم', price: '۲۸۰,۰۰۰ تومان', rawPrice: 280000, 
    hasColors: true, gender: 'girl', type: 'socks',
    img1: 'https://images.unsplash.com/photo-1503919545889-aef636e10ad4?q=80&w=600&auto=format&fit=crop',
    img2: 'https://images.unsplash.com/photo-1622290319146-7b63df48a635?q=80&w=600&auto=format&fit=crop'
  },
];
...
function BabyCategoryContent() {
  ...
  return (
    // تغییر رنگ پس‌زمینه به تم نوزادی (f4f7f6)
